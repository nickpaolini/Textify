...
const teamMembers = [
  {
    ...
    role: 'Sales Lead',
    avatar:
      'https://ui-avatars.com/api/?name=Alex+Johnson&background=0a2540&color=fff',
    mobility: 80,
    ffh: 65,
    shs: 90,
  },
  {
    ...
    avatar:
      'https://ui-avatars.com/api/?name=Jamie+Lee&background=0a2540&color=fff',
    mobility: 55,
    ffh: 75,
    shs: 60,
  },
  {
    ...
    role: 'Field Rep',
    avatar:
      'https://ui-avatars.com/api/?name=Morgan+Smith&background=0a2540&color=fff',
    mobility: 95,
    ffh: 80,
    shs: 70,
  },
    ...
    <section className="w-full max-w-2xl mx-auto mt-12">
      ...
      <div className="flex flex-col gap-6">
        {teamMembers.map((member) => (
          <Card
            key={member.name}
            className="flex flex-col md:flex-row items-center gap-6 p-6 shadow-md"
          >
