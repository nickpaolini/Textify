      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <div className="bg-muted rounded p-3 min-h-[120px] overflow-x-auto">
            {markdown ? (
              <pre className="whitespace-pre-wrap text-sm">{getOutputContent("markdown", markdown)}</pre>
            ) : (
        ...
        <Card>
          ...
          <div className="bg-muted rounded p-3 min-h-[120px]">
            {brief ? (
              <span className="whitespace-pre-wrap text-sm">{getOutputContent("brief", brief)}</span>
            ) : (
              <span className="text-muted-foreground">
                Output will appear here.
              </span>
